  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-red-900 to-black text-white overflow-hidden">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="p-6">
              <div className="text-3xl md:text-4xl font-black text-gray-900 mb-2">$2.5B+</div>
              <div className="text-gray-600 font-medium">Foreign Direct Investment (2024)</div>
            </div>
            <div className="p-6">
              <div className="text-3xl md:text-4xl font-black text-gray-900 mb-2">1,425+</div>
              <div className="text-gray-600 font-medium">Active Investment Projects</div>
            </div>
            <div className="p-6">
              <div className="text-3xl md:text-4xl font-black text-gray-900 mb-2">1M+</div>
              <div className="text-gray-600 font-medium">Jobs Created (UIA Target Achieved)</div>
            </div>
            <div className="p-6">
              <div className="text-3xl md:text-4xl font-black text-gray-900 mb-2">6.0%</div>
              <div className="text-gray-600 font-medium">GDP Growth Rate (2024)</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-900 via-red-900 to-black text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-6 py-3 bg-yellow-500/20 text-yellow-300 rounded-full text-sm font-medium mb-6 border border-yellow-500/30 backdrop-blur-sm">
              <MapIcon className="w-5 h-5 mr-2" />
              <span>Your Investment Journey Starts Here</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-black text-white mb-6">
              Ready to 
              <span className="block bg-gradient-to-r from-yellow-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">
                Start Investing?
              </span>
            </h2>
