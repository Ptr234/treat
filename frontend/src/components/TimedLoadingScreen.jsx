...
const TimedLoadingScreen = ({ children, minLoadTime = 4000 }) => {
        ...
        <motion.div className="mb-8">
          ...
          <div className="w-64 h-1 bg-gray-700 rounded-full mx-auto mb-4 overflow-hidden">
            <motion.div
              ...
              initial={{ width: "0%" }}
              animate={{ width: "100%" }}
              transition={{ duration: minLoadTime / 1000, ease: "easeInOut" }}
            />
          </div>
        </motion.div>
...
export default TimedLoadingScreen