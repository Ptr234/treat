  ...
  const navigationItems = useMemo(() => [
    ...
    { 
      ...
      dropdown: [
        ...
        { name: 'Investment Onboarding', href: '/investment-onboarding', icon: '🚀' }
      ]
    },
    { 
      ...
      dropdown: [
        ...
        { name: 'Business Registration & Licensing', href: '/registration-wizard', icon: '🏢' },
        { name: 'Tax & Revenue Services', href: '/services?category=Tax & Revenue Services', icon: '🧮' },
        { name: 'Immigration & Work Permits', href: '/services?category=Immigration & Work Permits', icon: '📋' },
        { name: 'Export & Import Services', href: '/services?category=Export & Import Services', icon: '📦' },
    ...
    { 
      ...
      dropdown: [
        ...
        { name: 'Document Checklist', href: '/document-checklist', icon: '✅' },
        { name: 'Investment Status Tracker', href: '/tools?tool=status-tracker', icon: '📍' },
    ...
    { 
      ...
      icon: '📁',
      dropdown: [
        { name: 'Investment Guides', href: '/downloads?category=investment-guides', icon: '📖' },
        { name: 'Legal Documents', href: '/downloads?category=legal', icon: '⚖️' },
        { name: 'Tax Information', href: '/downloads?category=tax', icon: '💰' },
        { name: 'Sector Reports', href: '/downloads?category=reports', icon: '📊' },
        { name: 'All Resources', href: '/downloads', icon: '📁' }
      ]
    },
    { 
      ...
      icon: '🤝',
      dropdown: [
        { name: 'Investment Consultation', href: '/support?type=investment', icon: '💼' },
        { name: 'Agency Directory', href: '/agencies', icon: '🏢' },
        { name: 'Emergency Support', href: '/support?section=emergency', icon: '🚨' },
        { name: 'Investor FAQ', href: '/support?section=investor-faq', icon: '❓' }
      ]
    }
  ], [])
