...
export const INVESTMENT_OPPORTUNITIES: Omit<InvestmentOpportunity, 'contact' | 'logo'>[] = [
...
export const getInvestmentWithContact = (investment: Omit<InvestmentOpportunity, 'contact' | 'logo'>): InvestmentOpportunity => {
...
export const getAllInvestmentsWithContacts = (): InvestmentOpportunity[] => {
