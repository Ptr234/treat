...
const HomePage = () => {
  ...
  // Enhanced hero slides with better image management
  const heroSlides = useMemo(() => [
    {
      id: 'kampala',
      image: '/images/uganda-kampala-city-view.webp',
      title: 'Uganda Investment Hub',
      subtitle: 'East Africa\'s Fastest Growing Economy',
      cta: 'Start Your Journey',
      stats: { label: 'GDP Growth', value: '6.5%', trend: '+2.1%' }
    },
    {
      id: 'tourism',
      image: '/images/Tourism.webp',
      title: 'Tourism Excellence',
      subtitle: '$1.8B Annual Tourism Revenue',
      cta: 'Explore Opportunities',
      stats: { label: 'Tourism Growth', value: '24%', trend: '+8.3%' }
    },
    {
      id: 'infrastructure',
      image: '/images/Infrastucture.webp',
      title: 'Modern Infrastructure',
      subtitle: 'Connecting East Africa Markets',
      cta: 'Infrastructure Deals',
      stats: { label: 'Projects Active', value: '342', trend: '+67' }
    },
    {
      id: 'pride',
      image: '/images/Pride.webp',
      title: 'Investment Pride',
      subtitle: '60+ Years of Sustainable Growth',
      cta: 'Legacy Investments',
      stats: { label: 'Success Rate', value: '97%', trend: '+4%' }
    }
  ], [])
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setLiveStats(prev => ({
        fdi: Math.max(0, prev.fdi + (Math.random() - 0.4) * 0.02),
        gdp: Math.max(0, prev.gdp + (Math.random() - 0.3) * 0.08),
        businesses: prev.businesses + Math.floor(Math.random() * 5),
        services: Math.min(200, prev.services + (Math.random() > 0.92 ? 1 : 0)),
          ...
          <div className="max-w-7xl mx-auto flex justify-between items-center text-xs md:text-sm">
            <div className="flex space-x-6">
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <span className="font-medium">GDP: {liveStats.gdp.toFixed(1)}%</span>
              </motion.div>
              <motion.div
            ...
            <div className="text-yellow-300 font-semibold">
              🔴 LIVE: {liveStats.investors} Active Investors
            </div>
          </div>
        </motion.div>
