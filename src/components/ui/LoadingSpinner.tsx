...
export function LoadingSpinner({ 
  ...
  const colorClasses = {
    yellow: 'border-yellow-400 border-t-yellow-600',
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-8 shadow-2xl flex flex-col items-center">
        ...
        <p className="text-lg font-semibold text-black-700">Loading Uganda Investment Portal...</p>
      </div>
    </div>
  );
}
...
export function SkeletonStats() {
  return (
    <div className="bg-gradient-to-r from-black-800/95 to-black-900/95 backdrop-blur-xl rounded-3xl px-6 py-8 md:px-12 md:py-10 mx-4 border border-yellow-500/30 shadow-2xl w-full max-w-6xl">
