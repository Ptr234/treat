              ...
              <div className="grid gap-3">
                {currentStepData?.options.map((option) => (
                  <button
                    ...
                    className="p-4 border-2 border-gray-200 rounded-xl hover:border-red-300 hover:bg-red-50 transition-all duration-200 text-left group focus:ring-2 focus:ring-red-500 focus:outline-none"
                  >
